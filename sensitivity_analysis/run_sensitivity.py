...
def load_config(config_path="sensitivity_analysis/config/parameter_space.yaml"):
...
def main():
    ...
    asset_data = prepare_asset_data("sensitivity_analysis/config/assets_sensitivity.yaml", args.seed)
