...
def main():
    ...
    parser.add_argument('--results-dir', type=str, default='03_sensitivity_analysis/data_parameters/results/raw_sobol',
    ...
    output_dir = Path("03_sensitivity_analysis/data_parameters/results")
